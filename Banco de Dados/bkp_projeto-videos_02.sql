...
INSERT INTO `filmes` VALUES (1,'Aquaman','ação',2018,'Com a ajuda da princesa Mera, Aquaman precisa recuperar o lendário Tridente de Atlan e aceitar seu\ndestino como protetor das profundezas'),(2,'Bacurau','drama',2019,'Os moradores de Bacurau, um pequeno povoado do sertão brasileiro, descobrem que a comunidade não\nconsta mais em qualquer mapa'),(3,'O Esquadrão Suicida','ação',2021,'Um time dos mais perigosos e encarcerados supervilões são contratados por uma agência secreta do\ngoverno, para combater uma poderosa entidade'),(4,'A Familia Adans 2: Pé na Estrada','comédia',2021,'Pegando a estrada para uma viagem assustadora, os Addams espalham caos e sustos por todo o país'),(5,'Harry Potter e a Pedra Filosofal','fantasia',2001,'*Harry adentra um mundo mágico que jamais imaginara, vivendo diversas aventuras com seus novos\namigos, Rony Weasley e Hermione Granger'),(6,'Invocação do Mal','terror',2013,'Os investigadores paranormais Ed e Lorraine Warren trabalham para ajudar a família aterrorizada por\numa entidade demoníaca em sua fazenda'),(7,'Michael Jackson This is It','documentario',2009,'Resultado de uma edição de mais de cem horas de gravação, o diretor Kenny Ortega revela cenas raras\nda intimidade de Michael Jackson'),(8,'Oito Mulheres e um Segredo','comedia',2018,'Recém-saída da prisão, Debbie Ocean logo procura sua ex-parceira Lou para realizar um elaborado\nassalto: roubar um colar de diamantes no valor de 150 milhões de dólares, que a empresa Cartier mantém\nem um cofre'),(9,'Pânico 5','terror',2022,'Um novo assassino se apropria da máscara de Ghostface e começa a perseguir um grupo de adolescentes\npara trazer à tona segredos do passado mortal da cidade'),(10,'Hotel Transilvania 3: Férias Monstruosas','fantasia',2018,'A família faz um cruzeiro para que Drácula possa sair de férias e abandonar por uns dias seu trabalho no\nHotel Transilvânia'),(11,'Rambo: Programado para Matar','ação',1982,'Um veterano da Guerra do Vietnã usa todo seu treinamento e agressividade exercitada nos campos de\nbatalha quando é preso e torturado por policiais'),(12,'Cinquenta Tons de Liberdade','romance',2018,'Christian Grey e sua nova esposa, Anastasia, abraçam completamente sua inseparável ligação, mas\neventos terríveis começam a comprometer seu final feliz antes mesmo de começar'),(13,'Como eu era antes de você','romance',2016,'De origem modesta e sem grandes aspirações, a peculiar Louisa Clark é contratada para ser cuidadora de\nWill, um jovem tetraplégico depressivo e cínico'),(14,'A Freira','terror',2018,'Presa em um convento na Romênia, uma freira comete suicídio'),(15,'A hora do Rush','ação',1998,'A filha de um diplomata chinês é sequestrada em Los Angeles e o cônsul chama o inspetor Lee em Hong\nKong para ajudar o FBI com o caso'),(16,'Corra','terror',2017,'Chris é um jovem fotógrafo negro que está prestes a conhecer os pais de Rose, sua namorada caucasiana.\nCom o tempo, ele percebe que a família dela esconde algo muito perturbador'),(17,'Em Defesa de Cristo','drama',2017,'Um jornalista investigativo, ateu convicto, parte em uma investida para desmentir a existência de Deus\napós sua esposa tornar-se cristã'),(18,'Homem Aranha: Sem volta pra Casa','ação',2021,'O Homem-Aranha precisa lidar com as consequências da sua verdadeira identidade ter sido descoberta'),(19,'Shrek','comedia',2001,'Era uma vez um pântano distante, onde vivia um ogro chamado Shrek. De repente, seu sossego é\ninterrompido pela invasão de personagens de contos de fadas que foram banidos de seu reino pelo\nmaldoso Lorde Farquaad'),(20,'Valoses e Furiosos 9','ação',2021,'Dominic Toretto e Letty vivem uma vida pacata ao lado do filho. Mas eles logo são ameaçados pelo\npassado de Dom, seu irmão desaparecido Jakob, que retorna e está trabalhando ao lado de Cipher. Cabe a\nDom reunir a equipe novamente para enfrentá-los'),(21,'Tô Ryca ','comédia',2016,'Selminha é uma frentista que recebe uma herança de família, mas somente se cumprir o desafio de gastar\n30 milhões de reais em 30 dias, sem acumular nada');
